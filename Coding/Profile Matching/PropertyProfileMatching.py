...
persona_map = {
    ...
    "Pasangan Bekerja tanpa Anak": "Berkeluarga tanpa Anak",
    "Pasangan Bekerja dengan Anak": "Berkeluarga dengan Anak"
}
...
top_n = 10
top_properties = df.sort_values(by='final_score', ascending=False).head(top_n)
top_properties[['title', 'persona', 'final_score', 'url']].to_csv("top_recommended_properties.csv", index=False)

print(f"\n✅ Top {top_n} recommended properties saved to 'top_recommended_properties.csv'")