...
from ProfileMatching import determine_persona
from PropertyProfileMatching import apply_profile_matching
import random
from google.cloud import firestore

# Initialize the Firestore client
# On Cloud Run, it will authenticate automatically
db = firestore.Client()

def load_data_from_firestore():
    """Loads all property data from the 'properties' collection in Firestore."""
    properties_ref = db.collection('properties')
    docs = properties_ref.stream() # stream() gets all documents

    # Convert the documents to a list of dictionaries
    properties_list = [doc.to_dict() for doc in docs]
